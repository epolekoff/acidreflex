...
public class Water : MonoBehaviour
{
    ...
    {
        //Spawning our water
        SpawnWater(-7.5f, 15.5f, -12, -14.5f);
    }
    ...
    public void Splash(float xpos, float velocity)
    {
        ...
        if (xpos >= xpositions[0] && xpos <= xpositions[xpositions.Length - 1])
        {
            ...
            if (useParticles)
            {
                ...
                Vector3 position = new Vector3(xpositions[index], ypositions[index] - 0.35f, z);
    ...
    public void SpawnWater(float Left, float Width, float Top, float Bottom)
    {
        ...
        gameObject.GetComponent<BoxCollider>().center = new Vector3(Left + Width / 2, (Top + Bottom) / 2, z);
        gameObject.GetComponent<BoxCollider>().size = new Vector3(Width, Top - Bottom, 1);
        ...
        for (int i = 0; i < edgecount; i++)
        {
            ...
            colliders[i].transform.position = new Vector3(Left + Width * (i + 0.5f) / edgecount, Top - 0.5f, z+1);
